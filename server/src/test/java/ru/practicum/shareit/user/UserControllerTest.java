...
class UserControllerTest {
    ...
    public void test_T0020_PS01_updateUser() throws Exception {
        Mockito.when(userService.updateUser(anyUserId, userRequestDto))
                .thenReturn(userResponseDto);
        ...
        Mockito.verify(userService, Mockito.times(1)).updateUser(anyUserId, userRequestDto);
        Mockito.verifyNoMoreInteractions(userService);
    }
    ...
    public void test_T0050_PS01_getUsers() throws Exception {
        ...
        Mockito.when(userService.getAll(0, 10))
        ...
        Mockito.verify(userService, Mockito.times(1)).getAll(0, 10);
        Mockito.verifyNoMoreInteractions(userService);
    }
}