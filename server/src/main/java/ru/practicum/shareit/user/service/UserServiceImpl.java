...
public class UserServiceImpl implements UserService {
    ...
    @Transactional
    @Override
    public UserResponseDto updateUser(final long userId, final UserRequestDto userRequestDto) {
    ...
    @Override
    public List<UserResponseDto> getAll(final int from, final int size) {
