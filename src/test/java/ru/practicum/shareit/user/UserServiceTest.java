...
class UserServiceTest {
    ...
    public void test_T0020_PS01_updateUser() {
        ...
        UserResponseDto updated = userService.updateUser(userRequestDto, anyUserId);
    ...
    public void test_T0020_PS02_updateUser_otherEmail() {
        ...
        UserResponseDto updated = userService.updateUser(userRequestDto1, anyUserId);
    ...
    public void test_T0020_PS03_updateUser_withEmptyFields() {
        ...
        UserResponseDto updated = userService.updateUser(new UserRequestDto(), anyUserId);
        assertEquals(userResponseDto, updated);
    ...
    public void test_T0030_NS01_updateUser_noUserWithId() {
        ...
        assertThrows(UserNotFoundException.class, () -> userService.updateUser(new UserRequestDto(), anyUserId));
    ...
    public void test_T0030_NS02_updateUser_emailValidation() {
        ...
        assertThrows(EmailFieldValidationException.class, () -> userService.updateUser(new UserRequestDto("any name", invalidEmail), anyUserId));
    ...
    public void test_T0030_NS03_updateUser_sameEmailValidation() {
        ...
        assertThrows(SameUserEmailException.class, () -> userService.updateUser(new UserRequestDto("any name", invalidEmail), anyUserId));
