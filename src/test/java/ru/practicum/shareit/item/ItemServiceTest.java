...
//        Comment for Item without Request
    ...
    @Test
    public void test_T0040_NS01_getItemsByOwner_invalidPagination() {
        assertThrows(InvalidPaginationSizeException.class, () -> itemService.getItemsByOwner(anyOwnerId, -1, 0));
    ...
    @Test
    public void test_T0050_NS01_searchItems_invalidPagination() {
        assertThrows(InvalidPaginationSizeException.class, () -> itemService.searchItems(anyOwnerId, text, -1, 0));
