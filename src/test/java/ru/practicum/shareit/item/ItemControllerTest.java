...
//        Нет валидации контента isOk()
    ...
    @Test
    public void test_T0030_NS03_getItem_noPathVariable_itemId() throws Exception {
//      Есть такой ednpoint, не проверить
    }

    @Test
    public void test_T0030_NS04_getItem_invalidPathVariable_itemId() throws Exception {
    ...
    @Test
    public void test_T0060_NS01_createComment_invalidContent() throws Exception {
    ...
    @Test
    public void test_T0060_NS02_createComment_noRequestHeader_ownerId() throws Exception {
        String response = mvc.perform(post("/items/" + anyItemId + "/comment")
                        .content(mapper.writeValueAsString(commentRequestDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void test_T0060_NS03_createComment_invalidRequestHeader_ownerId() throws Exception {
        String response = mvc.perform(post("/items/" + anyItemId + "/comment")
                        .content(mapper.writeValueAsString(commentRequestDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void test_T0060_NS04_createComment_noPathVariable_itemId() throws Exception {
    ...
    @Test
    public void test_T0060_NS05_createComment_invalidPathVariable_itemId() throws Exception {
