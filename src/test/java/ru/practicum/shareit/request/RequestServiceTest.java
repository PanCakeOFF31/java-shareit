...
class RequestServiceTest {
    ...
    @Test
    public void test_T0020_NS02_getRequestByRequester_invalidPagination() {
        assertThrows(InvalidPaginationSizeException.class,
                () -> requestService.getRequestsByRequester(anyRequesterId, -1, 0));
    ...
    @Test
    public void test_T0030_NS02_getAll_invalidPagination() {
        assertThrows(InvalidPaginationSizeException.class,
                () -> requestService.getAll(anyRequesterId, -1, 0));
