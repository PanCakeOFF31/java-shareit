...
class BookingControllerTest {
    ...
    public void test_T0040_PS01_getAllBookingByBooker() throws Exception {
        ...
        Mockito.when(bookingService.getAllBookingByBooker(anyLong(), anyString(), anyInt(), anyInt()))
                .thenReturn(response);
        ...
        mvc.perform(get("/bookings")
                        ...
                        .accept(MediaType.APPLICATION_JSON)
                        .header(REQUEST_USER_HEADER, anyBookeOrOwnerId)
                        .param("required", Status.WAITING.toString())
        ...
        Mockito.verify(bookingService, Mockito.times(1)).getAllBookingByBooker(anyLong(), anyString(), anyInt(), anyInt());
        Mockito.verifyNoMoreInteractions(bookingService);
    }
    ...
    public void test_T0050_PS01_getAllBookingByOwner() throws Exception {
        ...
        Mockito.when(bookingService.getAllBookingByOwner(anyLong(), anyString(), anyInt(), anyInt()))
                .thenReturn(response);
        ...
        Mockito.verify(bookingService, Mockito.times(1)).getAllBookingByOwner(anyLong(), anyString(), anyInt(), anyInt());
        Mockito.verifyNoMoreInteractions(bookingService);
    }
